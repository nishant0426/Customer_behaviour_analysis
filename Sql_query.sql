...
--Q3 What are the top 5 products with the highest average review rating rating?
alter table customer rename column item_purchased to products;

SELECT products,
       ROUND(AVG(CAST(review_rating AS NUMERIC)), 2) AS avg_product_rating
FROM customer
GROUP BY products
